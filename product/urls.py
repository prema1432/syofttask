...
from product.api.ProductListAPIView import PaginatedProductListAPIView, ProductListAPIView
...
urlpatterns = [
    ...
    path("list-paginated/", PaginatedProductListAPIView.as_view(), name="product-paginated-list"),
